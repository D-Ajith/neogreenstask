  ...
  return (
    <section className="w-full flex justify-center items-center py-8 md:py-12 lg:py-16 px-4 md:px-6 bg-[#FAFAF5]">
      <div className="max-w-6xl w-full">
        <div className="bg-[#2C4143] rounded-xl md:rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 relative">
          ...
          <div className="flex flex-col justify-center px-6 py-10 sm:px-8 sm:py-12 md:px-10 lg:px-12 md:py-12 lg:py-14 relative z-10">
            <h2 
              ...
              className="text-[#efecd6] text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-[2.75rem] font-semibold mb-4 md:mb-5 lg:mb-6 leading-[1.2]"
            >
            ...
            <p 
              ...
              className="text-[#efecd6] text-sm sm:text-base md:text-base lg:text-lg mb-6 md:mb-7 lg:mb-8 leading-relaxed font-medium"
            >
            ...
            <button 
              style={{ fontFamily: "Raleway, sans-serif", fontWeight: 500 }}
              className="bg-[#efecd6] text-[#2C4143] text-base md:text-lg font-medium rounded-full px-8 py-3 md:px-9 md:py-3.5 w-fit shadow-md hover:bg-[#DDE2D5] hover:shadow-lg transition-all"
            >
              Our Story
            </button>
          </div>
